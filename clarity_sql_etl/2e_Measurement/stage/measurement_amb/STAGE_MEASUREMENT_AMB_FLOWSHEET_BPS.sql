/*
Purpose: Extract and transform blood pressure measurements from ambulatory flowsheets
Source: PULL_MEASUREMENT_AMB_FLOWSHEET
Target: MEASUREMENT table (OMOP CDM)
Description: This query specifically handles systolic blood pressure measurements
*/

-- CTE for Blood Pressure Source to Concept Mapping
...
-- CTE for Ambulatory Visit Source to Concept Mapping
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_MEASUREMENT_AMB_FLOWSHEET AS PULL_MEASUREMENT_AMB_FLOWSHEET
    ...
    -- Join to get blood pressure concepts
    ...
    -- Join to get ambulatory visit concepts
