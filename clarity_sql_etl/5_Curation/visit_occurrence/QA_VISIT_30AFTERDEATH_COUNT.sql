/*********************************************************
* Script Name: QA_VISIT_30AFTERDEATH_COUNT.sql
* Author: Roger J Carlson - Corewell Health
* Date: June 2025
* 
* Description: This script identifies visits recorded more than 
* 30 days after a patient's death date in the OMOP CDM.
*********************************************************/
...
WITH VISIT30AFTERDEATH_COUNT AS (
    SELECT 
        ...
        SUM(CASE 
            WHEN (DATEDIFF(DAY, DEATH_DATE, VISIT_START_DATE) > 30) 
            THEN 1 
            ELSE 0 
        END) AS CNT
...
*
* Logic:
* 1. Identifies visits that occurred more than 30 days after
*    a patient's recorded death date
* 2. Counts the number of such invalid records
* 3. Compares raw and clean table record counts
*
* Legal Warning:
* This code is provided as-is without any implied warranty.
* Use at your own risk. No guarantee of accuracy or 
