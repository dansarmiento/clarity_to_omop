...
--BEGIN cte__TOP_HSP_RXNORM
    ...
    FROM {{ref('PULL_DRUG_EXPOSURE_HOSP_RXNORM')}} AS PULL_DRUG_EXPOSURE_HOSP_RXNORM
    INNER JOIN (
        SELECT CONCEPT_CODE
            ,CONCEPT_CLASS_ID
        ...
        ON PULL_DRUG_EXPOSURE_HOSP_RXNORM.PULL_RXNORM_CODE = CONCEPT_CODE
 --    WHERE PULL_DRUG_EXPOSURE_HOSP_RXNORM.RXNORM_TERM_TYPE_C <> 2 --2 - PRECISE INGREDIENT
--END cte__TOP_HSP_RXNORM
--
