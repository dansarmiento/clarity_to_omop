--STAGE_CONDITION_OCCURRENCE_AMB_SNO
{#-- {{ config(materialized = 'view', schema = 'OMOP_STAGE') }}#}

SELECT DISTINCT
	PULL_CONDITION_OCCURRENCE_AMB_SNO.PERSON_ID							AS PERSON_ID
	-- ,CASE
	-- 	WHEN PULL_CONDITION_OCCURRENCE_AMB_SNO.CONDITION_START_DATE :: DATE >= '2015-10-01'
...
FROM {{ref('PULL_CONDITION_OCCURRENCE_AMB_SNO')}} AS PULL_CONDITION_OCCURRENCE_AMB_SNO
