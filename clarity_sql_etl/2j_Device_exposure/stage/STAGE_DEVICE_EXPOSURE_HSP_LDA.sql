/*
Purpose: Transform and map device exposure data from hospital LDA sources
Source Tables: 
...
-- CTE to filter device-specific concept mappings
...
-- Main query to generate device exposure records
SELECT DISTINCT
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_DEVICE_EXPOSURE_HOSP_LDA AS PULL_DEVICE_EXPOSURE_HOSP_LDA
