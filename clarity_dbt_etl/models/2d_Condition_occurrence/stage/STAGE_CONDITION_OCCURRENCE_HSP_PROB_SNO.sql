--STAGE_CONDITION_OCCURRENCE_HSP_PROB_SNO
...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID
    ...
    ,CASE WHEN CONDITION_STATUS_SOURCE_VALUE = 'PRIMARY_PROB'
            THEN '32902'
        ELSE '32908'
...
FROM {{ref('PULL_CONDITION_OCCURRENCE_HOSP_PROB_SNO')}} AS PULL_CONDITION_OCCURRENCE_HOSP_PROB_SNO
