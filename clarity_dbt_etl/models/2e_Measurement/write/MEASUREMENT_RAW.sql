--MEASUREMENT_RAW
{{ config(materialized = 'table', schema = 'OMOP', cluster_by = ['MEASUREMENT_ID']) }}

SELECT
    {{ sequence_get_nextval() }}::NUMBER(28,0)      AS MEASUREMENT_ID
...
(   --HSP
    ...
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_BMI')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_BPD')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_BPS')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_MISC')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_TEMPERATURE')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_HOSP_FLOWSHEET_VITALS')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
    ...
    FROM {{ref('STAGE_MEASUREMENT_HOSP_LOINC')}}
...
--     --AMB
    ...
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
     FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_BMI')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_BPD')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_BPS')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_MISC')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_TEMPERATURE')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_FLOWSHEET_VITALS')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI,STAGE_CSN_ID
        ,'LNC_DB_MAIN' as SRC_TABLE, 'RECORD_ID' AS SRC_FIELD, STAGE_RECORD_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_AMB_LOINC')}}
...
--     --ANES
    ...
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_BPD')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_BPM')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_BPS')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_MISC')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_TEMPERATURE')}}
    UNION ALL
    SELECT PERSON_ID, MEASUREMENT_CONCEPT_ID, MEASUREMENT_DATE, MEASUREMENT_DATETIME
        , MEASUREMENT_TYPE_CONCEPT_ID, OPERATOR_CONCEPT_ID, try_to_double(VALUE_AS_NUMBER) AS VALUE_AS_NUMBER, VALUE_AS_CONCEPT_ID
        , UNIT_CONCEPT_ID, RANGE_LOW, RANGE_HIGH, PROVIDER_ID, VISIT_OCCURRENCE_ID, VISIT_DETAIL_ID
        ...
        , ETL_MODULE, STAGE_PAT_ID, STAGE_MRN_CPI, STAGE_CSN_ID
        ,'IP_FLO_GP_DATA' as SRC_TABLE, 'FLO_MEAS_ID' AS SRC_FIELD, STAGE_FLO_MEAS_ID::INTEGER AS SRC_VALUE_ID
    FROM {{ref('STAGE_MEASUREMENT_ANES_FLOWSHEET_VITALS')}}
