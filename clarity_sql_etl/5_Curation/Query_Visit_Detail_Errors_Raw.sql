/*********************************************************
Script Name: Query_Visit_Detail_Errors_Raw
Author: Roger J Carlson - Corewell Health
Date: June 2025
Description: Retrieves error details for Visit Detail records by joining
            QA error table with Visit Detail raw data.
**********************************************************/
...
VISIT_DETAIL.*: All columns from the VISIT_DETAIL_RAW table

LOGIC:
------
1. Joins QA error table with Visit Detail raw data using VISIT_DETAIL_ID
2. Filters for errors specific to the VISIT_DETAIL table
3. Returns all error information along with complete visit detail record
