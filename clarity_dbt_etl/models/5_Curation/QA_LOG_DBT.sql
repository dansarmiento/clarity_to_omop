...
UNION ALL SELECT  * FROM
{{ref('QA_DEATH_NULL_DEATHDATE_COUNT')}} AS QA_DEATH_NULL_DEATHDATE_COUNT
...
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_INGREDIENTCLASS_COUNT')}} AS QA_DRUG_EXPOSURE_INGREDIENTCLASS_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_DRUG_SOURCE_VALUE_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_DRUG_SOURCE_VALUE_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_PROVIDER_ID_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_PROVIDER_ID_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_REFILLS_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_REFILLS_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_STOP_REASON_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_STOP_REASON_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_VERBATIM_END_DATE_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_VERBATIM_END_DATE_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_DRUG_EXPOSURE_POS_DUP_VISIT_OCCURRENCE_ID_COUNT')}} AS QA_DRUG_EXPOSURE_POS_DUP_VISIT_OCCURRENCE_ID_COUNT
...
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_LOW_HIGH_COUNT')}} AS QA_MEASUREMENT_POS_DUP_LOW_HIGH_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_MEASUREMENT_SOURCE_VALUE_COUNT')}} AS QA_MEASUREMENT_POS_DUP_MEASUREMENT_SOURCE_VALUE_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_PROVIDER_COUNT')}} AS QA_MEASUREMENT_POS_DUP_PROVIDER_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_UNIT_CONCEPT_ID_COUNT')}} AS QA_MEASUREMENT_POS_DUP_UNIT_CONCEPT_ID_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_VALUE_SOURCE_VALUE_COUNT')}} AS QA_MEASUREMENT_POS_DUP_VALUE_SOURCE_VALUE_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_MEASUREMENT_POS_DUP_VISIT_OCCURRENCE_COUNT')}} AS QA_MEASUREMENT_POS_DUP_VISIT_OCCURRENCE_COUNT
...
UNION ALL SELECT  * FROM
{{ref('QA_OBSERVATION_POS_DUP_PROVIDER_ID_COUNT')}} AS QA_OBSERVATION_POS_DUP_PROVIDER_ID_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_OBSERVATION_POS_DUP_VISIT_OCCURRENCE_ID_COUNT')}} AS QA_OBSERVATION_POS_DUP_VISIT_OCCURRENCE_ID_COUNT

--PERSON
UNION ALL SELECT  * FROM
{{ref('QA_PERSON_WO_VISIT_COUNT')}} AS QA_PERSON_WO_VISIT_COUNT
UNION ALL SELECT  * FROM
...
{{ref('QA_PROCEDURE_OCCURRENCE_ZEROCONCEPT_COUNT')}} AS QA_PROCEDURE_OCCURRENCE_ZEROCONCEPT_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_PROCEDURE_OCCURRENCE_POS_DUP_PROVIDER_ID_COUNT')}} AS QA_PROCEDURE_OCCURRENCE_POS_DUP_PROVIDER_ID_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_PROCEDURE_OCCURRENCE_POS_DUP_VISIT_OCCURRENCE_ID_COUNT')}} AS QA_PROCEDURE_OCCURRENCE_POS_DUP_VISIT_OCCURRENCE_ID_COUNT
...
--VISIT_DETAIL
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_30AFTERDEATH_COUNT')}} AS QA_VISIT_DETAIL_30AFTERDEATH_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_DATEVDATETIME_COUNT')}} AS QA_VISIT_DETAIL_DATEVDATETIME_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_DUPLICATES_COUNT')}} AS QA_VISIT_DETAIL_DUPLICATES_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_END_BEFORE_START_COUNT')}} AS QA_VISIT_DETAIL_END_BEFORE_START_COUNT
{#UNION ALL SELECT  * FROM
{{ref('xxx')}} AS QA_VISIT_DETAIL_NOMATCH_COUNT #}
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_NONSTANDARD_COUNT')}} AS QA_VISIT_DETAIL_NONSTANDARD_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_NULLCONCEPT_COUNT')}} AS QA_VISIT_DETAIL_NULLCONCEPT_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_NULLFK_COUNT')}} AS QA_VISIT_DETAIL_NULLFK_COUNT
UNION ALL SELECT  * FROM
{{ref('QA_VISIT_DETAIL_ZEROCONCEPT_COUNT')}} AS QA_VISIT_DETAIL_ZEROCONCEPT_COUNT
