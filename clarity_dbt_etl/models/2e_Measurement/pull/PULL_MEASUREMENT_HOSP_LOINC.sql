...
FROM {{ref('PULL_VISIT_OCCURRENCE_HSP')}} AS PULL_VISIT_OCCURRENCE_HSP
	...
	-- LEFT JOIN {{ ref('CLARITY_SER_stg')}} AS ATTEND_PROVIDER
	-- 	ON PULL_VISIT_OCCURRENCE_HSP.BILL_ATTEND_PROV_ID = ATTEND_PROVIDER.PROV_ID
...
WHERE (ZC_ORDER_STATUS_NAME <> 'Canceled')
