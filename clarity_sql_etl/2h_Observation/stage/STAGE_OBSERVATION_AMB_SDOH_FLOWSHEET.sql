/*
Purpose: This query transforms ambulatory SDOH (Social Determinants of Health) flowsheet data into the OMOP Observation table format
Source Tables: 
...
-- Main Query for STAGE_OBSERVATION_AMB_SDOH_FLOWSHEET
SELECT DISTINCT
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_OBSERVATION_AMB_FLOWSHEET AS PULL_OBSERVATION_AMB_FLOWSHEET

    -- Join to get SDOH measurement concepts
