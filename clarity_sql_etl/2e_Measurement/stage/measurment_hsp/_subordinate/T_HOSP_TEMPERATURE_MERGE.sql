/*
Purpose: This query merges temperature measurements with their source information and maps them to standard concepts
Tables Used:
- CARE_RES_OMOP_GEN_WKSP.OMOP.SOURCE_TO_CONCEPT_MAP
- CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_HOSP_TEMPERATURE
- CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_HOSP_TEMP_SOURCE
*/

-- CTE to get temperature-specific concept mappings
...
-- Main query to merge temperature measurements with source information
SELECT 
    T_TEMPERATURE.PERSON_ID AS PERSON_ID,
...
FROM 
    CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_HOSP_TEMPERATURE AS T_TEMPERATURE
    
    -- Join with temperature source information
    INNER JOIN CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_HOSP_TEMP_SOURCE AS T_TEMP_SOURCE
