...
SELECT 'DRUG_EXPOSURE_START_DATE' AS METRIC_FIELD, 'DATEVDATETIME' AS QA_METRIC, 'WARNING' AS ERROR_TYPE,
	SUM(CASE WHEN (DRUG_EXPOSURE_START_DATE <> CAST(DRUG_EXPOSURE_START_DATETIME AS DATE)) THEN 1 ELSE 0 END) AS CNT
...
SELECT 'DRUG_EXPOSURE_END_DATE' AS METRIC_FIELD, 'DATEVDATETIME' AS QA_METRIC, 'WARNING' AS ERROR_TYPE,
	SUM(CASE WHEN (DRUG_EXPOSURE_END_DATE <> CAST(DRUG_EXPOSURE_END_DATETIME AS DATE)) THEN 1 ELSE 0 END) AS CNT
FROM {{ref('DRUG_EXPOSURE_RAW')}} AS T1
)
