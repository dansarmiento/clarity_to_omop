/*
Purpose: Transform and load anesthesia flowsheet vital measurements into OMOP CDM format
Source: PULL_MEASUREMENT_ANES_FLOWSHEET
Target: MEASUREMENT table
*/

-- CTE for vital signs source-to-concept mappings
...
-- CTE for inferred units source-to-concept mappings
...
SELECT DISTINCT
    ...
    'MEASUREMENT_ANES_FLOWSHEET_VITALS' AS ETL_MODULE,
