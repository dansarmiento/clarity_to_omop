--STAGE_CONDITION_OCCURRENCE_HSP_TDL_SNO
{#-- {{ config(materialized = 'view', schema = 'OMOP_STAGE') }}#}

SELECT DISTINCT
	PULL_CONDITION_OCCURRENCE_HOSP_TDL_SNO.PERSON_ID
	-- ,CASE
	-- 	WHEN PULL_CONDITION_OCCURRENCE_HOSP_ICD.CONDITION_START_DATE >= '2015-10-01'
...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID
    ...
    ,CASE WHEN CONDITION_STATUS_SOURCE_VALUE = 'PRIMARY_DX'
...
FROM {{ref('PULL_CONDITION_OCCURRENCE_HOSP_TDL_SNO')}} AS PULL_CONDITION_OCCURRENCE_HOSP_TDL_SNO
