...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID --to be added
...
FROM {{ref('PULL_MEASUREMENT_AMB_LOINC')}} AS PULL_MEASUREMENT_AMB_LOINC
...
-- WHERE PULL_MEASUREMENT_AMB_LOINC.ZC_ORDER_STATUS_NAME <> 'Canceled'
-- 		AND PULL_MEASUREMENT_AMB_LOINC.SPECIMN_TAKEN_TIME IS NOT NULL
