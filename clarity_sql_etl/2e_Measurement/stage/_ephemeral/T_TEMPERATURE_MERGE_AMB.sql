...
--
    ...
    FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_TEMPERATURE_AMB AS T_TEMPERATURE
    LEFT JOIN CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_TEMP_SOURCE_AMB AS T_TEMP_SOURCE
