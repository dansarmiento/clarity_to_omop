/*
Purpose: This query combines temperature measurements with their source mappings
Tables Used:
- CARE_RES_OMOP_GEN_WKSP.OMOP.SOURCE_TO_CONCEPT_MAP
- CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_ANES_TEMPERATURE
- CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_ANES_TEMP_SOURCE
*/

-- CTE to get temperature source mappings
...
-- Main query to merge temperature measurements with their sources
SELECT 
...
FROM 
    CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_ANES_TEMPERATURE AS T_TEMPERATURE
    LEFT JOIN CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_ANES_TEMP_SOURCE AS T_TEMP_SOURCE
