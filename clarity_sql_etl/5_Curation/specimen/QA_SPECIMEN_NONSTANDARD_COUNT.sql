/*********************************************************
Script Name: QA_SPECIMEN_NONSTANDARD_COUNT
Author: Roger J Carlson - Corewell Health
Date: June 2025

Description: This script performs quality assurance checks on the SPECIMEN table
by identifying non-standard concept IDs across various fields.
...
Logic:
1. Checks for non-standard concepts in specimen-related fields
2. Validates against appropriate domains and vocabularies
3. Counts occurrences of non-standard concepts
4. Aggregates results with relevant metadata

Legal Warning:
This code is provided "AS IS" without warranty of any kind.
Use at your own risk. The author and organization make no
representations about the suitability, reliability, or accuracy
of this code for any purpose.
*********************************************************/