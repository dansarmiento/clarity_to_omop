/*
Purpose: Extract and transform blood pressure diastolic measurements from ambulatory flowsheets
Source: PULL_MEASUREMENT_AMB_FLOWSHEET
Target: MEASUREMENT table
*/

-- CTE for Blood Pressure Diastolic Flowsheet Measurements
...
-- CTE for Flowsheet Measurement Units
...
-- CTE for Ambulatory Visit Types
...
SELECT DISTINCT
    ...
    -- Non-OMOP Fields
    'MEASUREMENT_AMB_FLOWSHEET_BPD' AS ETL_MODULE,
