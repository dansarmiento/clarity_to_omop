...
----QA_CONDITION_30AFTERDEATH_COUNT
-------------------------------------------------------------------

{# --{{ config(materialized = 'view') }} #}

WITH CONDITION30AFTERDEATH_COUNT AS (
SELECT 'CONDITION_START_DATE' AS METRIC_FIELD, '30AFTERDEATH' AS QA_METRIC, 'INVALID DATA' AS ERROR_TYPE,
	SUM(CASE WHEN (DATEDIFF(DAY, DEATH_DATE, CONDITION_START_DATE) > 30) THEN 1 ELSE 0 END) AS CNT
