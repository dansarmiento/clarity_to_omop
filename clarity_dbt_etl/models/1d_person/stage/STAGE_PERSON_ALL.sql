...
FROM {{ref('PULL_PERSON_ALL') }} AS PULL_PERSON_ALL
    ...
    LEFT JOIN {{ ref('SOURCE_TO_CONCEPT_MAP_RACE')}} AS SOURCE_TO_CONCEPT_MAP_RACE
        ON PULL_PERSON_ALL.PATIENT_RACE_C::VARCHAR = SOURCE_TO_CONCEPT_MAP_RACE.SOURCE_CODE

    LEFT JOIN {{ ref('SOURCE_TO_CONCEPT_MAP_ETHNICITY')}} AS SOURCE_TO_CONCEPT_MAP_ETHNICITY
