/*******************************************************
 * SQL Query: STAGE_MEASUREMENT_ANES_FLOWSHEET_TEMPERATURE
 * Purpose: Transforms anesthesia flowsheet temperature measurements into OMOP format
 * Source Tables: T_ANES_TEMPERATURE_MERGE, SOURCE_TO_CONCEPT_MAP, VISIT_OCCURRENCE_RAW, PROVIDER_RAW
 *******************************************************/

-- CTE for temperature-related flowsheet measurements mapping
...
SELECT DISTINCT
    ...
    'MEASUREMENT_ANES_FLOWSHEET_TEMPERATURE'               AS ETL_MODULE,
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_STAGE.T_ANES_TEMPERATURE_MERGE AS T_TEMPERATURE_MERGE

    -- Join to get temperature measurement concepts
    ...
    -- Join to get measurement unit concepts
...
-- Filter out records without a target concept
