/*********************************************************
Script Name: Query_Drug_Exposure_Errors
...
INNER JOIN 
    ...
    AND QA_ERR_DBT.CDT_ID = DRUG_EXPOSURE.DRUG_EXPOSURE_ID
WHERE
...
QA_METRIC: Quality assessment metric being evaluated
...
2. Matches records based on DRUG_EXPOSURE_ID
