...
with __dbt__cte__SOURCE_TO_CONCEPT_MAP_AMB_VISIT as (
...
LEFT JOIN  CARE_RES_OMOP_DEV2_WKSP.OMOP.CARE_SITE_RAW AS CARE_SITE ON
	PULL_VISIT_OCCURRENCE_AMB.PULL_CARE_SITE_ID = CARE_SITE.CARE_SITE_ID
LEFT JOIN  CARE_RES_OMOP_DEV2_WKSP.OMOP.PROVIDER_RAW AS PROVIDER ON
...
LEFT JOIN CARE_RES_OMOP_DEV2_WKSP.OMOP.DEATH_RAW AS DEATH ON
	PULL_VISIT_OCCURRENCE_AMB.PERSON_ID = DEATH.PERSON_ID
INNER JOIN  __dbt__cte__SOURCE_TO_CONCEPT_MAP_AMB_VISIT AS SOURCE_TO_CONCEPT_MAP_AMB_VISIT ON
