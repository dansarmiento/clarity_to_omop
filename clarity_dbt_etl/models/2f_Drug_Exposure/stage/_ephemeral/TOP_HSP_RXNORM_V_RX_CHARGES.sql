...
--BEGIN cte__TOP_HSP_RXNORM_V_RX_CHARGES
    ...
    FROM {{ref('PULL_DRUG_EXPOSURE_HOSP_V_RX_CHARGES')}} AS PULL_DRUG_EXPOSURE_HOSP_V_RX_CHARGES
    INNER JOIN (
        SELECT CONCEPT_CODE
            ,CONCEPT_CLASS_ID
        ...
        ON PULL_DRUG_EXPOSURE_HOSP_V_RX_CHARGES.PULL_RXNORM_CODE = CONCEPT_CODE
 --    WHERE PULL_DRUG_EXPOSURE_HOSP_V_RX_CHARGES.RXNORM_TERM_TYPE_C <> 2 --2 - PRECISE INGREDIENT
--END cte__TOP_HSP_RXNORM_V_RX_CHARGES
--
