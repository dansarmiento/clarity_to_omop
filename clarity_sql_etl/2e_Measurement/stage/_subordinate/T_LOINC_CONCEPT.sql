/***************************************************************
* Query: Lab Test Concept Mapping
* Description: Retrieves standard LOINC lab test concepts and their 
* source concepts using the 'Maps to' relationship
*
* Tables:
...
WHERE 
    ...
    AND UPPER(C2.DOMAIN_ID) = 'MEASUREMENT'       -- Must be in measurement domain
    AND UPPER(C2.VOCABULARY_ID) = 'LOINC'         -- Must be from LOINC vocabulary
    AND UPPER(C2.CONCEPT_CLASS_ID) = 'LAB TEST'   -- Must be a lab test
;