/*
Purpose: This query retrieves temperature measurements from hospital flowsheet data
         by joining flowsheet measurements with their corresponding concept mappings.

Tables Used:
- CARE_RES_OMOP_GEN_WKSP.OMOP.SOURCE_TO_CONCEPT_MAP
- CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_MEASUREMENT_HOSP_FLOWSHEET
...
WITH __dbt__cte__SOURCE_TO_CONCEPT_MAP_FLOWSHEET_MEAS_TEMP AS (
    -- Get temperature-specific concept mappings
    SELECT *
...
-- Join with temperature concept mappings
