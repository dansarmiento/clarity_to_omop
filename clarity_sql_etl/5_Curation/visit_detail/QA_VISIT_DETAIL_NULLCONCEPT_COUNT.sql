...
Date: June 2025
Description: Quality assurance check for null concepts in VISIT_DETAIL table
**********************************************************/
...
Logic:
------
1. Checks for null values in VISIT_DETAIL_CONCEPT_ID and VISIT_DETAIL_TYPE_CONCEPT_ID
2. Counts occurrences of null values for each field
3. Compares raw and clean table record counts
4. Flags null occurrences as FATAL errors
