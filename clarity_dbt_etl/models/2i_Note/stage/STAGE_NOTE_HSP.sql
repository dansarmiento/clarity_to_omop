...
--CDM.SEQ_NOTE.NEXTVAL AS NOTE_ID
	...
	-- ,PULL_NOTE_HOSP_ALL.NOTE_TEXT 									AS NOTE_TEXT
	-- ******************************************
...
FROM {{ref('PULL_NOTE_HOSP_ALL')}} AS PULL_NOTE_HOSP_ALL
    ...
    INNER JOIN {{ref('T_NOTE_DATE_HSP_MAX')}} AS T_MAX_NOTE_DATE
        ON PULL_NOTE_HOSP_ALL.PULL_NOTE_ID = T_MAX_NOTE_DATE.PULL_NOTE_ID
       -- AND PULL_NOTE_HOSP_ALL.PULL_NOTE_LINE= T_MAX_NOTE_DATE.PULL_NOTE_LINE
...
WHERE PULL_NOTE_HOSP_ALL.NOTE_DATE IS NOT NULL
	--AND PULL_NOTE_HOSP_ALL.PULL_NOTE_LINE = 1
