/***************************************************************
 * Script: STAGE_CONDITION_OCCURRENCE_HSP_DISCH_SNO
 * Description: Retrieves and transforms hospital discharge condition data
...
SELECT DISTINCT
    ...
    -- Determine condition status concept ID based on discharge diagnosis type
    CASE 
        WHEN CONDITION_STATUS_SOURCE_VALUE = 'PRIMARY_DISCHARGE_DX'    THEN '32903'
        WHEN CONDITION_STATUS_SOURCE_VALUE = 'SECONDARY_DISCHARGE_DX'  THEN '32909'
        ELSE '32896'
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_CONDITION_OCCURRENCE_HOSP_DISCH_SNO 
    AS PULL_CONDITION_OCCURRENCE_HOSP_DISCH_SNO
...
-- Filter for valid condition concepts
