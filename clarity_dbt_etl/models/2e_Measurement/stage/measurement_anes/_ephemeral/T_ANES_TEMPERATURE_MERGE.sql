...
--BEGIN cte__T_ANES_TEMPERATURE_MERGE
    ...
    FROM {{ref('T_ANES_TEMPERATURE')}} AS T_TEMPERATURE
    LEFT JOIN {{ref('T_ANES_TEMP_SOURCE')}} AS T_TEMP_SOURCE
...
--END cte__T_ANES_TEMPERATURE_MERGE
--
