...
the QA error table with the death raw data table.
*********************************************************/
...
- DEATH.*: All columns from the DEATH_RAW table

LOGIC:
1. Joins QA error table with DEATH_RAW table using PERSON_ID
2. Filters for records specifically related to the DEATH table
