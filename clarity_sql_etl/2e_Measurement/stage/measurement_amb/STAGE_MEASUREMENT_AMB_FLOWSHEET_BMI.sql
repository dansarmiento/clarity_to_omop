/*
Purpose: This query transforms ambulatory BMI flowsheet measurements into the OMOP CDM format
Source Tables: 
...
-- CTE for BMI Flowsheet Measurements Mapping
...
SELECT DISTINCT
    ...
    'MEASUREMENT_AMB_FLOWSHEET_BMI' AS ETL_MODULE,
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_MEASUREMENT_AMB_FLOWSHEET AS PULL_MEASUREMENT_AMB_FLOWSHEET
    ...
    -- Join to get BMI measurement concepts
    ...
    -- Join to get ambulatory visit information
