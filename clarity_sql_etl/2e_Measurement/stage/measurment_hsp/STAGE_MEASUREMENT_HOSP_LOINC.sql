/*
Purpose: This query transforms hospital LOINC measurements data into OMOP CDM format
Source Tables: 
...
-- Main query for STAGE_MEASUREMENT_HOSP_LOINC
SELECT DISTINCT
...
FROM CARE_RES_OMOP_DEV2_WKSP.OMOP_PULL.PULL_MEASUREMENT_HOSP_LOINC AS PULL_MEASUREMENT_HOSP_LOINC
